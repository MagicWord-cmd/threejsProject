    ...
    gltf => {
        ...
        model.traverse(function (object) {
            ...
            if (object.isMesh) {
                ...
                object.material.emissive = oldMaterial.emissive
                object.material.emissiveIntensity = oldMaterial.emissiveIntensity

                //map
                if (oldMaterial.map) {
                    oldMaterial.map.colorSpace = THREE.SRGBColorSpace;
                    object.material.map = oldMaterial.map;
                }

                //lightMap
                if (oldMaterial.clearcoatMap) {
                    oldMaterial.clearcoatMap.colorSpace = THREE.SRGBColorSpace;

                    //todo 拷贝clearcoatMap赋值于lightMap，并设置lightMapIntensity和envMapIntensity的值。
                    object.material.lightMap = oldMaterial.clearcoatMap.clone();
                ...
                if (oldMaterial.emissiveMap) {
                    oldMaterial.emissiveMap.colorSpace = THREE.SRGBColorSpace;
                    object.material.lightMap = oldMaterial.emissiveMap;
                }
                // //aoMap
