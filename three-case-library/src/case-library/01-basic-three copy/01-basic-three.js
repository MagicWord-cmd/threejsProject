...
let renderer, camera, stats, controls, AxesHelper, evnFolder;
...
function init() {
    ...
    gltfLoader.load(modelsApi.modelsList + '.glb',
    ...
    function initCamera(closured) {
        ...
        //todo 动态设置坐标辅助控件大小
        AxesHelper = new THREE.AxesHelper(obj.maxBox3Size * 0.6);
        ...
        rgbeLoader.loadAsync("/src/assets/textures/ninomaru_teien_2k.hdr").then((hdrTexture) => {
            ...
            scene.background = new THREE.Color(0x254141);
